...
const Dashboard = () => {
	return (
		<main className="">
			<div className="flex h-72 flex-col items-center justify-center space-y-2 bg-gradient-to-b from-blue-charcoal-500 via-blue-charcoal-400 to-background px-4 py-12 text-primary dark:from-blue-charcoal-500 dark:to-background">
				<Badge className="gap-1">
					<SparklesIcon size={14} />
					<Separator orientation="vertical" />
					Nosso editor está em desenvolvimento
				</Badge>
				...
				<p className="text-center text-sm text-muted-foreground dark:text-blue-charcoal-100/80">
